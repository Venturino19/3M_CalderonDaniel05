...
class Formulario:
    def __init__(self, root):
        ...
        tk.Label(root, text="Teléfono:").grid(row=4, column=0, padx=10, pady=5, sticky='e')
        ...
        tk.Label(root, text="Género:").grid(row=5, column=0, padx=10, pady=5, sticky='e')
    ...
    def limpiar_datos(self):
        ...
        messagebox.showinfo("Información", "Datos borrados exitosamente")
